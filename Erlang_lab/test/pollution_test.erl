...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
get_area_mean_test() ->
  M = pollution:add_station("Stacja 3", {3,3}, pollution:add_station("Stacja 2", {0,2}, pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor()))),
  M1 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 10, M),
  M2 = pollution:add_value("Stacja 2", {{2023,3,27},{11,16,11}}, "PM10", 20, M1),
  M3 = pollution:add_value("Stacja 1", {{2024,3,27},{11,16,12}}, "PM10", 30, M2),
  M4 = pollution:add_value("Stacja 2", {{2023,4,27},{11,16,13}}, "PM10", 20, M3),

  M5 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,14}}, "PM25", 100, M4),
  M6 = pollution:add_value("Stacja 2", {{2023,3,22},{11,16,15}}, "PM25", 220, M5),

  M7 = pollution:add_value("Stacja 3", {{2023,3,27},{11,16,18}}, "PM10", 1234, M6),
  M8 = pollution:add_value("Stacja 3", {{2023,3,29},{11,16,18}}, "PM25", 10, M7),

  ?assertMatch(15.0, pollution:get_area_mean("PM10",{0,1},2, M2)),
  ?assertMatch(20.0, pollution:get_area_mean("PM10",{0,1},1, M3)),
  ?assertMatch(1234.0, pollution:get_area_mean("PM10",{2,3},1, M7)),
  ?assertMatch(20.0, pollution:get_area_mean("PM10",{0,1},2, M4)),
  ?assertMatch(20.0, pollution:get_area_mean("PM10",{0,1},3, M7)),
  ?assertMatch(160.0, pollution:get_area_mean("PM25",{0,1},2, M8)),
  ?assertMatch(262.8, pollution:get_area_mean("PM10",{0,2},5, M8)),
  ?assertMatch(110.0, pollution:get_area_mean("PM25",{0,2},5, M8)).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
get_area_mean_fail_test() ->
  M = pollution:add_station("Stacja 2", {2,2}, pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor())),
  ?assertMatch({error, _}, pollution:get_area_mean("PM10",{0,0},200, M)),
  M1 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 10, M),
  M2 = pollution:add_value("Stacja 2", {{2023,3,27},{11,16,11}}, "PM10", 20, M1),
