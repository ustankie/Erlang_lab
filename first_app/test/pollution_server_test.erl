...
add_station_test() ->
  ...
  A=pollution_gen_server:add_station("Stacja 1", {1,1}),
...
add_value_fail_test() ->
  ...
  pollution_gen_server:add_station("Stacja 1", {1,1}),
  Time = calendar:local_time(),
  M1=pollution_gen_server:add_value("Stacja 1", Time, "PM10", 46.3),
...
remove_value_and_add_back_test() ->
  ...
  pollution_gen_server:add_value("Stacja 1", {{2023,3,27},{11,16,9}}, "PM10", 46.3),
  M3=pollution_gen_server:get_monitor(),
  pollution_gen_server:remove_value("Stacja 1", {{2023,3,27},{11,16,9}}, "PM10"),
  M4 = pollution_gen_server:get_monitor(),
  ?assertNotEqual(M4, M3),

  pollution_gen_server:add_value({1,1}, {{2023,3,27},{11,16,9}}, "PM10", 46.3),
  M5=pollution_gen_server:get_monitor(),
  ?assertEqual(M5, M3),
  pollution_gen_server:stop().
...
get_station_mean_test() ->
  ...
  M2=pollution_gen_server:get_monitor(),
...
get_daily_mean_test() ->
  ...
  pollution_gen_server:add_value("Stacja 2", {{2023,3,27},{11,16,15}}, "PM25", 220),
    M6=pollution_gen_server:get_monitor(),



  pollution_gen_server:add_value("Stacja 3", {{2023,3,27},{11,16,18}}, "PM10", 1234),
    M9=pollution_gen_server:get_monitor(),
...
get_area_mean_test() ->
  pollution_gen_server:start_link(),
  pollution_gen_server:add_station("Stacja 2", {0,2}),
  pollution_gen_server:add_station("Stacja 1", {1,1}),
  pollution_gen_server:add_station("Stacja 3", {3,3}),
  pollution_gen_server:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 10),
  pollution_gen_server:add_value("Stacja 2", {{2023,3,27},{11,16,11}}, "PM10", 20),
  ?assertMatch(15.0, pollution_gen_server:get_area_mean("PM10",{0,1},2)),

  pollution_gen_server:add_value("Stacja 1", {{2024,3,27},{11,16,12}}, "PM10", 30),
  ?assertMatch(20.0, pollution_gen_server:get_area_mean("PM10",{0,1},1)),
  pollution_gen_server:add_value("Stacja 2", {{2023,4,27},{11,16,13}}, "PM10", 20),
  ?assertMatch(20.0, pollution_gen_server:get_area_mean("PM10",{0,1},2)),


  pollution_gen_server:add_value("Stacja 1", {{2023,3,27},{11,16,14}}, "PM25", 100),
  pollution_gen_server:add_value("Stacja 2", {{2023,3,22},{11,16,15}}, "PM25", 220),

  pollution_gen_server:add_value("Stacja 3", {{2023,3,27},{11,16,18}}, "PM10", 1234),
  ?assertMatch(1234.0, pollution_gen_server:get_area_mean("PM10",{2,3},1)),
  ?assertMatch(20.0, pollution_gen_server:get_area_mean("PM10",{0,1},3)),
  pollution_gen_server:add_value("Stacja 3", {{2023,3,29},{11,16,18}}, "PM25", 10),

  ?assertMatch(160.0, pollution_gen_server:get_area_mean("PM25",{0,1},2)),
  ?assertMatch(262.8, pollution_gen_server:get_area_mean("PM10",{0,2},5)),
  ?assertMatch(110.0, pollution_gen_server:get_area_mean("PM25",{0,2},5)),
  pollution_gen_server:stop().
...
get_area_mean_fail_test() ->
  ...
  pollution_gen_server:add_station("Stacja 1", {1,1}),
  pollution_gen_server:add_station("Stacja 3", {3,3}),
  ?assertMatch({error, _}, pollution_gen_server:get_area_mean("PM10",{0,0},200)),
  pollution_gen_server:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 10),
  pollution_gen_server:add_value("Stacja 2", {{2023,3,27},{11,16,11}}, "PM10", 20),
  M2=pollution_gen_server:get_monitor(),
